...
weixinRoutes.get('/api/pilot/weixin/qrcode', async (ctx) => {
  try {
...
weixinRoutes.get('/api/pilot/weixin/qrcode/status', async (ctx) => {
...
weixinRoutes.post('/api/pilot/weixin/save', async (ctx) => {
