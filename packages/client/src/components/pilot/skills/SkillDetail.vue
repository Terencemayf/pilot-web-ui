...
import MarkdownRenderer from '@/components/pilot/chat/MarkdownRenderer.vue'
import { fetchSkillContent, fetchSkillFiles, type SkillFileEntry } from '@/api/pilot/skills'
...
async function viewFile(filePath: string) {
  ...
  try {
    ...
    if (filePath.startsWith('/')) {
      ...
      const segments = filePath.split('/.pilot/skills/')[1]
      if (segments) {
