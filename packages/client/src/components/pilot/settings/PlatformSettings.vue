...
import { saveCredentials as saveCredsApi, fetchWeixinQrCode, pollWeixinQrStatus, saveWeixinCredentials } from '@/api/pilot/config'
...
// Save credentials to .env (matching pilot gateway setup behavior)
