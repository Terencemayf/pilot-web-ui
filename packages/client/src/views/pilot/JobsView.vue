...
import JobsPanel from '@/components/pilot/jobs/JobsPanel.vue'
import JobFormModal from '@/components/pilot/jobs/JobFormModal.vue'
import { useJobsStore } from '@/stores/pilot/jobs'
