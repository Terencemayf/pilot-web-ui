...
import SkillList from '@/components/pilot/skills/SkillList.vue'
import SkillDetail from '@/components/pilot/skills/SkillDetail.vue'
import { fetchSkills, type SkillCategory } from '@/api/pilot/skills'
