...
import { useSettingsStore } from '@/stores/pilot/settings'
import DisplaySettings from '@/components/pilot/settings/DisplaySettings.vue'
import AgentSettings from '@/components/pilot/settings/AgentSettings.vue'
import MemorySettings from '@/components/pilot/settings/MemorySettings.vue'
import SessionSettings from '@/components/pilot/settings/SessionSettings.vue'
import PrivacySettings from '@/components/pilot/settings/PrivacySettings.vue'
import SettingRow from '@/components/pilot/settings/SettingRow.vue'
